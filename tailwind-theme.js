export default {
  ...
  "family:text": {
    ...
    input:
      "w-full px-3 py-2 border-none text-base text-red-700 placeholder-red-400",
  },
  "family:date": {
    inner:
      "flex items-center max-w-md ring-1 ring-green-400 focus-within:ring-green-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-green-500 rounded mb-1",
    input: "w-full px-3 py-2 border-none text-green-700 placeholder-green-600",
  },
  ...
  select: {
    inner:
      "flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-white-500",
    input:
      'w-full pl-3 pr-8 py-2 border-none text-base text-red-700 placeholder-red-400 formkit-multiple:p-0 data-[placeholder="true"]:text-red-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
    selectIcon:
      "flex p-[3px] shrink-0 w-5 mr-2 -ml-[1.5em] h-full pointer-events-none [&>svg]:w-[1em]",
    option: "formkit-multiple:p-3 formkit-multiple:text-sm text-green-700",
  },
  textarea: {
    inner:
